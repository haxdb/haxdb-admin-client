...
<td width=300> <select class='form-control' id='FIELDSET-SELECT' class='pull-right'> <option value='0'>DEFAULT FIELDSET</option> </select> </td>
...
load_udf = function(){
	api("UDF/list", { "context": "<?= $context ?>" }, load_udf_callback);
}

load_fieldsets = function(){
    api("FIELDSET/list", { "context": "<?= $context ?>" }, load_fieldset_callback);
}
